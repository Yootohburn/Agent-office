...
const PLATFORM_COLOR: Record<AgentPlatform, string> = {
  shopee: '#ff5722',
  lazada: '#2979ff',
  tiktok: '#00e5ff',
  shared: '#00ff9f',
...
export default function AgentStatusCard({ agent, selected, onClick }: Props) {
  ...
  const platformColor = PLATFORM_COLOR[agent.platform]
  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: 6 }}>
        ...
        <div style={{ background: '#1a2540', height: 6, position: 'relative' }}>
          <div
            style={{
